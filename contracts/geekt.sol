...
contract Geekt {
  ...
  function getUsers() internal view returns (address[] storage) { return usersByAddress; }

  function getUser(address userAddress) internal view returns (string,bytes32,bytes32,bytes32,bytes32[] storage) {
  ...
  function getAllImages() internal view returns (bytes32[] storage) { return imagesByNotaryHash; }

  function getUserImages(address userAddress) internal view returns (bytes32[] storage) { return Users[userAddress].myImages; }

  function getImage(bytes32 SHA256notaryHash) internal view returns (string,uint) {
